...
edge_ref = geompy.GetSubShape(Shell_1, [7])  # ID d'une arête existante
edge_length = geompy.BasicProperties(edge_ref)[0]  # [0] = longueur
...
result = Mesh_1.ExtrusionSweepObjects(
    [Mesh_1], [Mesh_1], [Mesh_1],
    [0, 0, 1],
    height, 1, [], 0, [], [], 0
)
Mesh_3D = result[0]
# Mesh_1.ExtrusionSweepObjects( [ Mesh_1 ], [ Mesh_1 ], [ Mesh_1 ], [ 0, 0, 1 ], height, 1, [  ], 0, [  ], [  ], 0 )
